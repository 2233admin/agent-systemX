import type { ControlPlaneFacade, ControlPlaneUnknown, ClientCapability, ConfigRevisionRef, AssemblyManifestRef, LaunchPlanRef } from '../../application/control-plane-port.ts';
...
export class ControlPlaneHostAdapter implements HostAdapter {
  public constructor(private readonly facade: ControlPlaneFacade, private readonly revisionId: string, private readonly clientId: 'omp' | 'claude') {}
